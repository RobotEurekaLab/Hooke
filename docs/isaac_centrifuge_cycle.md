...
MuJoCo 最终冻结版本 `3080443` 的十种子专家为 10/10，60 秒空动作对照误通过 0/10。此前 `cd2a861` 的 Isaac 完整原生试验回合通过，仿真 39.61 秒、实际耗时 604.501 秒；最终 `3080443` 的十种子专家及 60 秒对照正在验收。未完成回合不计为通过。
